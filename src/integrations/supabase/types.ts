  ...
  public: {
    Tables: {
      budget_rooms: {
        ...
        Relationships: [
          {
            foreignKeyName: "budget_rooms_budget_id_fkey"
            columns: ["budget_id"]
            isOneToOne: false
      ...
      budget_service_materials: {
        ...
        Relationships: [
          {
            foreignKeyName: "budget_service_materials_budget_service_id_fkey"
      ...
      budget_services: {
        ...
        Relationships: [
          {
            foreignKeyName: "budget_services_room_id_fkey"
            columns: ["room_id"]
            isOneToOne: false
            referencedRelation: "budget_rooms"
            referencedColumns: ["id"]
          },
          {
